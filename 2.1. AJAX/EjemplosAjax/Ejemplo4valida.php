...
?>
<respuesta>
	<mensaje><?php echo validar($telefono,$codigo_postal,$fecha_nacimiento)?></mensaje>
	<parametros>
		<telefono><?php echo $telefono?></telefono>
		<codigo_postal><?php echo $codigo_postal?></codigo_postal>
		<fecha_nacimiento><?php echo $fecha_nacimiento?></fecha_nacimiento>
	</parametros>
</respuesta>